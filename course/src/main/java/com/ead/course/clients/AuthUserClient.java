...
public class AuthUserClient {
    ...
    public void postSubscriptionUserInCourse(UUID courseId, UUID userId) { //metodo de envia para a api de usuario, para ser salvo no bd

        String url = REQUEST_URL_AUTHUSER + "/users/" + userId +  "/courses/subscription"; //url que tem lá no UserCourseController api authuser
