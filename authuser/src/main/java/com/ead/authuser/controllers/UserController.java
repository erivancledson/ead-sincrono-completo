...
public class UserController {
    ...
    public ResponseEntity<Page<UserModel>> getAllUsers( SpecificationTemplate.UserSpec spec,
        ...
        if(courseId != null){
            //retorna o usuario que pertence ao curso especifico
            userModelPage = userService.findAll(SpecificationTemplate.userCourseId(courseId).and(spec), pageable); //spec é de uma biblioteca para filtros avancados as classes são ResolverConfig e SpecificationTemplate
        } else {
